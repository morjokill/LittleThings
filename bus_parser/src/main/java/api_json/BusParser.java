...
public class BusParser {
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                getCordsForBusAndWriteToFile("2754", dost);
                getCordsForBusAndWriteToFile("2435", centre);
                getCordsForBusAndWriteToFile("11934", centre);
                getCordsForBusAndWriteToFile("16638", centre);
                Thread.sleep(60000);
            } catch (Exception e) {
                System.out.println("Went wrong: " + e);
            }
    ...
    private static void initFile(String busNum, double[] rootCord) throws IOException {
        ...
        writeToFile("bus_parser/src/main/resources/" + busNum + ".txt", text);
    }

    private static void getCordsForBusAndWriteToFile(String busNum, double[] rootCord) throws IOException {
